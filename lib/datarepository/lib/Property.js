...
const { utils: { schedule: { scheduleToString } } } = require('@iondv/commons');
const { PropertyTypes, util: { equal }, data: { Property: IProperty }, DateTypes: DateType } = require('@iondv/meta-model-contracts');
...
Property.prototype = Object.create(IProperty.prototype);
